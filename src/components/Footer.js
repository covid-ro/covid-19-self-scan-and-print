  ...
  return (
    <Flex wrap='wrap' width='1400px' height='100px' mx='auto'>
      <Box
        ...
        color='brand.900'
        w='100%'>
        <Text fontSize='20px' color='black' maxW='60ch' mx='auto' mt='6'>
          <Trans id='footer' />
        </Text>
        <Stack direction='row' alignItems='center' justifyContent='center' mb='4'>
          <Image width='60px' height='60px' objectFit='center' src={sts} alt={<Trans id='sts' />} mx='12' />
          <Image height='80px' objectFit='cover' src={cn} alt='Citizen Next' mx='8' />
          <Image height='80px' objectFit='cover' src={uni} alt='Unicredit' mx='6' />
        </Stack>
      </Box>
    </Flex>
  )
